...
poseToggle.addEventListener("click", () => {
  ...
  poseToggle.setAttribute("aria-expanded", poseDropdown.classList.contains("open"));
...
function getCombinedCanvasDataURL() {
  ...
  ctx.drawImage(riveCanvas, 0, 0, riveCanvas.width, riveCanvas.height, 0, 0, width, height);
  ctx.drawImage(drawCanvas, 0, 0, drawCanvas.width, drawCanvas.height, 0, 0, width, height);
...
shareBtn.addEventListener("click", (e) => {
  ...
  shareBtn.setAttribute("aria-expanded", shareControls.classList.contains("open"));
  poseDropdown.classList.remove("open");
  poseToggle.setAttribute("aria-expanded", "false");
});
